...
void initState() {
  ...
  _currentImageUrl = widget.imageUrls.isNotEmpty ? widget.imageUrls[widget.initialIndex] : defaultImageUrl;
                  ...
                  CarouselSlider(
                    ...
                    options: CarouselOptions(
                      ...
                      onPageChanged: (index, reason) {
                        setState(() {
                          _currentIndex = index;
                          _currentImageUrl = widget.imageUrls.isNotEmpty ? widget.imageUrls[index] : defaultImageUrl;
                        });
                      },
                    ),
  ...
  leading: CircleAvatar(
    ...
    children: [
      Padding(
        padding: const EdgeInsets.only(top: 16.0), // Adjust the top padding to move the title down
        child: Text(username, style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 16)),
      ),
      const SizedBox(height: 13.0), // Add a vertical gap between title and subtitle
    ],
  ),
  subtitle: Text(review),
  contentPadding: const EdgeInsets.symmetric(horizontal: 0.0, vertical: 7.0), // Adjust the horizontal padding
  horizontalTitleGap: 1.0, // Add some gap between title and subtitle
);
